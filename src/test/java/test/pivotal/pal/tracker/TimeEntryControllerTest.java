...
public class TimeEntryControllerTest {
    ...
    private CounterService counterTest;
    private GaugeService gaugeTest;

    @Before
    public void setUp() throws Exception {
        timeEntryRepository = mock(TimeEntryRepository.class);
        counterTest = mock(CounterService.class);
        gaugeTest = mock(GaugeService.class);
        controller = new TimeEntryController(timeEntryRepository, counterTest, gaugeTest);
    }
